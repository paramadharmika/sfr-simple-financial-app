...
public class RegistrationCommand implements IRegistrationCommand {
    ...
    @Inject
    public RegistrationCommand(OkHttpClient client, Gson gson, IAppConfiguration appConfiguration) {
        this.client = client;
        this.gson = gson;
    ...
    public void executeAsync(final UserModel param) {
        ...
        Request request = new Request.Builder()
                .url(appConfiguration.getBaseUrl() + "register")
                .post(body)
                .build();
